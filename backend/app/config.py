...
class VectorDBSettings(BaseSettings):
    ...
    embedding_function: str = os.getenv("VECTOR_DB_EMBEDDING_FUNCTION", "sentence_transformer")
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", f"sqlite:///{os.path.abspath('data/app.db')}")
